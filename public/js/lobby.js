...
(function () {
    ...
    window.addEventListener('DOMContentLoaded', function () {
        ...
        socketClient.on('letsgo', function () {
            $('div.final-score, p.wait, a.ready').hide();
        ...
        socketClient.on('startQuestions', function (data) {
            freezeClick = false;
            console.log("TCL: questions)", data);
            round = data.round;
        ...
        //Selection de la reponse par le joueur
        ...
        socketClient.on('stopGame', function () {
            $('p.littleStory').empty();
            $('p.chrono, p.score, div.questions, p.question, p.littleStory').hide();
        ...
        socketClient.on('finalScore', function (finalScores) {
            ...
            $('div.final-score, div.final-score a.ready').show();
